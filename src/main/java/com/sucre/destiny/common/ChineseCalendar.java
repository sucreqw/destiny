 ...
 */
    ...
    public String toString() {
        ...
        buf.append(getSimpleGregorianDateString()).append(" | ")
                ...
                .append(get(CHINESE_SECTIONAL_TERM)).append("日") //阳历节的日子
                .append(getChinese(CHINESE_SECTIONAL_TERM)).append(" ")//节名字
                .append(get(CHINESE_PRINCIPLE_TERM)).append("日")//阳历气的日子
                .append(getChinese(CHINESE_PRINCIPLE_TERM));//气名字
        return buf.toString();
    }
